      ...
      <form className="pianifica-layout" onSubmit={salvaTour}>
        <section className="pianifica-card">
          ...
          <div className="pianifica-route-fields">
            ...
            <div className="pianifica-route-row"><span className="pianifica-route-letter arrivo">{letteraPercorso(passaggi.length + 1)}</span><AutocompleteLocalita value={giroCircolare?partenza:arrivo} onChange={aggiornaArrivo} placeholder="Arrivo" disabled={giroCircolare}/><div /></div>
          </div>
